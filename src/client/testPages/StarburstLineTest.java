...
public class StarburstLineTest {
	...
	private void render() {		
		...
		// }
		Vertex3D center1= new Vertex3D(0,0,0, Color.BLUE);
		Vertex3D center2= new Vertex3D(640,640,0, Color.RED);
		Vertex3D radialPoint = radialPoint(radius, angle);
		renderer.drawLine(center2, center1, panel);
	...
	private Vertex3D radialPoint(double radius, double angle) {
		...
		return new Vertex3D(x, y, 0, Color.BLUE);
	}
