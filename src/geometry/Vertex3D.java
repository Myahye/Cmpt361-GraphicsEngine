...
public class Vertex3D implements Vertex {
	...
	protected Point3DH screenSpacePoint;
	protected Point3DH cameraSpacePoint;
	...
	public Vertex3D(Point3DH point, Point3DH screenPoint, Point3DH cameraPoint, Color color) {
		super();
		this.point = point;
		this.screenSpacePoint = screenPoint;
		this.cameraSpacePoint = cameraPoint;
		this.color = color;
	}
	...
	public Point getScreenSpacePoint() {
		return screenSpacePoint;
	}

	public Point getCameraSpacePoint() {
